...
export const LEAGUES = [
  ...
  { id: 'wnba', label: 'WNBA',               path: 'basketball/wnba',       kind: 'team',  accent: '#f58fd0', short: 'WNBA', teams: 15 },
  ...
  { id: 'mls',  label: 'MLS',                path: 'soccer/usa.1',          kind: 'team',  accent: '#8fb8de', short: 'MLS', teams: 30 },
  { id: 'f1',   label: 'Formule 1',          path: 'racing/f1',             kind: 'event', accent: '#ff4d6d', short: 'F1', logo: F1_LOGO },
];
